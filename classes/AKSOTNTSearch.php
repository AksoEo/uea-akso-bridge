<?php
/* Adapted from GravTNTSearch.php in the tntsearch plugin */
...
class AKSOTNTSearch
{
    ...
    public function __construct($options = [])
    {
        ...
        $fuzzy = $config->get('plugins.tntsearch.fuzzy');
        ...
        // ignore options passed from tntsearch, because these contain overrides from search
        // queries. we do not want those.
        ...
        require_once('AKSOTNTTokenizer.php');
    }
    ...
    public function createIndex()
    {
        ...
        $indexer->setTokenizer(new AKSOTNTTokenizer());
